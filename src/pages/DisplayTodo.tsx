...
const DisplayTodo = (): JSX.Element => {
  ...
  const editTodo = (first: string, second: string): void => {
    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="text-4xl font-medium title-font mb-4 text-gray-900">Your DisplayTodo</h1>
          {tasks.length === 0 && (
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Your DisplayTodo will show up here. Please add a todo by going to the homepage
            </p>
          )}
        </div>
              ...
              <div className="h-full flex flex-col items-center text-center">
                ...
                <div className="w-full">
                  ...
                  <span className="inline-flex">
                    ...
                    <a className="ml-6 text-gray-500 cursor-pointer" href={`/edit/${item.title}`}>
