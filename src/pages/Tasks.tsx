...
export default function Home(): JSX.Element {
  const [task, setTask] = useState<{ title: string; desc: string ,status: string }>({ title: '', desc: '', status:''});
          ...
          <div className="container bg-white px-5 py-24 h-full mx-auto flex flex-wrap items-center">
            ...
            <div className="bg-[#5EBEC4] rounded-lg p-8 flex flex-col m-auto w-1/2 mt-10 md:mt-0">
              ...
              <div className="relative mb-4">
                ...
                <input onChange={onChange}  value={task.title} type="text" id="title"  name="title"
                  className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
                        ...
                        <div className="relative mb-4">
                              ...
                              <input  onChange={onChange}  value={task.desc} type="text" id="desc" name="desc"
                                className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base  outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                          </div>
                          ...
                          <div className="relative mb-4">
                              ...
                              <input  onChange={onChange}  value={task.status} type="text" id="status" name="status"
                                className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base  outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                          </div> 
